...
namespace ART
{
    ...
    public class CompMaintainableResourceBuilding : ThingComp
    {
        ...
        public override void PostSpawnSetup(bool respawningAfterLoad)
        {
            ...
            compFacilityInUse = parent.TryGetComp<CompThingInUse>();
            var map = parent.Map;
            if (maintainables.ContainsKey(map))
            {
                maintainables[map].Add(parent);
            }
            else
            {
                maintainables[map] = new HashSet<Thing> { parent };
            }
        }
        ...
        public override void PostDestroy(DestroyMode mode, Map previousMap)
        {
            ...
            {
                maintainables[previousMap].Remove(parent);
            }
