...
namespace ART
{
    ...
    public class Gizmo_ResourceStatus : Gizmo
    {
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
        {
            ...
            var contractedBox = rect.ContractedBy(6f);
            DrawWindowBackground(rect, hediffResource.def);
            var rect3 = contractedBox;
            ...
            float resourceAmount = resourceAmountCache.Value;
            float resourceCapacity = resourceCapacityCache.Value;
            float resourceStorage = resourceBatteryAmountCache.Value;
            float resourceStorageCapacity = resourceStorageCapacityCache.Value;

            var resourceAmountBar = contractedBox;
            ...
            if (resourceStorageCapacity > 0)
            {
                ...
                var labelRect = new Rect(resourceAmountBar.x, resourceAmountBar.y, resourceAmountBar.width, resourceAmountBar.height);
